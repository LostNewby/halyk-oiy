INSERT INTO public.users (id, phone, password, name, latitude, longitude, role)
    VALUES
        (1, '777777777', 'hashedpassword1', 'Uzbechka', 43.225683, 76.942217, 'SERVICE'),
        (2, '789789798', 'hashedpassword2', 'User Two1', 43.232432, 76.949049, 'SERVICE'),
        (3, '498486486', 'hashedpassword2', 'User Two2', 43.240134, 76.928852, 'SERVICE'),
        (4, '464531131', 'hashedpassword2', 'User Two3', 43.249758, 76.891297, 'SERVICE'),
        (5, '289391429', 'hashedpassword2', 'User Two4', 43.256109, 76.872729, 'SERVICE'),
        (6, '687461313', 'hashedpassword2', 'User Two5', 43.290965, 76.956170, 'SERVICE'),
        (7, '956156135', 'hashedpassword2', 'User Two6', 43.319898, 77.044370, 'SERVICE'),
        (8, '944351451', 'hashedpassword2', 'User Two7', 45.384189, 75.835312, 'SERVICE'),
        (9, '7754351960', '12345', 'Onlinebank', 43.226916, 76.943856, 'SERVICE'),
        (10, '7471445192', '12345', 'Halyk Market', 0.0, 0.0, 'SALE');
